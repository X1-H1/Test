...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            ...
            function queding()
            {
                 ...
                 var object=document.getElementsByName("kechengId");//返回的obeject是数组
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<c:forEach items="${requestScope.kechengList}" var="kecheng" varStatus="sta">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					<td bgcolor="#FFFFFF" align="center">
						${sta.index+1}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						${kecheng.kechengBianhao}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						${kecheng.kechengName}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						<input type="radio" name="kechengId" value="${kecheng.kechengId}"/>
					</td>
				</tr>
				</c:forEach>
			</table>
